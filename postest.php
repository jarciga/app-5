        ...
        <div class="container-fluid">
         ...
         <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">
                         <div id="" class="muted pull-left">Post Test</div>
                         </div>
...
?>
<?php $quiz_id=$_GET['id'];
 echo"<form  method=post action=save_answer_posttest.php?id=".$_GET['id'].">";
$score=select_info_multiple_key("select * from score_posttest
where student_id=$session_id and teacher_class_id=$get_id");
    ...
    and qtype='posttest' ORDER BY RAND()");
