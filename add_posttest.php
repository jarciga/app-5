...
<body>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="posttest_teacher.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Back</a>
								</div>
                            </div>
	...
	?>
		<script>
 		window.location = 'posttest_teacher.php<?php echo '?id='.$get_id; ?>'
		</script>
		<?php
		}
		?>
